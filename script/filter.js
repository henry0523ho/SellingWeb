...
function showPartProduct() {
    let type;
    let url = location.href;
    if(url == "http://localhost/workSpace/SellingWeb/book.html"){
        type = "BOOK";
    }
    else if(url == "http://localhost/workSpace/SellingWeb/clothes.html"){
        type = "CLOTHES";
    }
    else if(url == "http://localhost/workSpace/SellingWeb/3C.html"){
        type = "3C";
    }
    $.ajax({
        url : 'php/filter.php',
