    ...
    if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) {
        if($productId==""){
            if($productMethod == 0){ //不二價
                ...
                echo $bidLength;
                $sql = "INSERT INTO product (product_name, product_num, product_img, product_text, product_label, product_new_rate, product_info, product_cost, seller_id, raise, bidLength) VALUES('" . $productName . "','" . $productNum . "','" . $productImg . "','" . $productText . "','" . $productLabel . "','" . $productNewRate . "','" . $productInfo . "','" . $productCost . "','" . $_SESSION["userId"] . "','" . $productRaise . "','" . $bidLength . "');";
                $result = $conn->query($sql);
            }
            if ($result === TRUE) {
